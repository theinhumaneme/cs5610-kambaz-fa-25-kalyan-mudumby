    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Crack Two eggs on a skillet.</li>
          <li>Wait for the base of the omelette to get crispy and flip.</li>
          <li>Add salt and pepper as per taste.</li>
          <li>Enjoy a well cooked omelette</li>
        </ol>
        ...
        <ul id="wd-your-books">
          ...
          <li>Incognito - Secret Lives of our Brain</li>
          <li>Chip War</li>
        </ul>
      </div>
      <div id="wd-tables">
